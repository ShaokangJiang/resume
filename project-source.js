const projects_all = [
  {
    ...
    "year": 2025,
    "description": [
      "Developed a data pipeline to sample, pair, and harvest 50K YouTube recommendations using sock-puppet accounts.",
      "Developed a git-diff-inspired text algorithm to identify matching video pairs, achieving 97\\% accuracy (0.95 precision, 0.96 recall), and trained a custom BERT model to classify the political leaning of content."
    ]
  }, {
    "title": "Tiktok Recommendation Analysis",
    "technologies": ["JavaScript", "TikTok API", "Node.js", "Torch", "Python"],
    "level": "archive",
    "include": [],
    "loc": {
      "main": {
    ...
    "year": 2025,
    "description": [
      "Deployed a TikTok scrapping API system",
      "Analyzed the text emotion, political leaning, and lexical difference over time.",
      "Developed a custom data collection pipeline and API server to fetch and process metadata, comments, and transcripts for over 116,000 TikTok videos related to the 2024 US presidential election.",
      "Implemented NLP models (RoBERTa, BERT) and conducted statistical analyses (Kruskal-Wallis, Spearman's) to evaluate political bias, user sentiment, and lexical diversity across video transcripts and comments."
    ]
  }, {
    "title": "CursorRules",
    "technologies": ["JavaScript", "Github APIs", "Sourcegraph CLI", "LLMs"],
    "level": "archive",
    "include": [],
    "loc": {
      "autocoding": {
    ...
    "year": 2025,
    "description": [
      "Designed and developed a system to collect and analyze Cursor rules from 401 GitHub repositories, leveraging prompted LLMs to scale up the qualitative coding process. Analyzed human-AI collaboration using Cursor rules as a proxy, identifying four primary categories (Project, Convention, Guideline, LLM Directive) and revealing that developers adapt context types by programming language while applying traditional human-to-human documentation strategies to instruct AI. Published at \\textbf{MSR 2026}.",
    ]
  },
   {
    "title": "Rust Compiler",
    ...
    "year": 2023,
    "description": [
      "A Rust based assembly language (snek) interpreter. "
    ]
  }, {
    "title": "CursorRules",
    "technologies": ["JavaScript", "Github APIs", "Sourcegraph CLI", "LLMs"],
