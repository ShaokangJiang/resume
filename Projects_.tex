\resumeSubHeadingListStart
  \resumeProjectHeading
    {\textbf{Monitoring Extension} $|$ \emph{JavaScript, Rust, Chrome Extension, Apps Script, Express.js, Multimodal LLM}}{2026}
    \resumeItemListStart
      \resumeItem{Designed and developed a Chrome extension to monitor real-time user interactions, utilizing a JavaScript frontend bundled with rollup, a Rust-based multi-threads native host for cross-platform communication and high-fidelity image/data logging, and an Express.js backend bundled with SEA for asynchronous, streaming data processing.}
...
\resumeItem{Optimized multimodal AI performance with reasoning (chain-of-thought, self-reflection, programming-as-reasoning, planning, and cross-verification) to analyze inputs from network events, user interactions, and screenshots.}
    \resumeItemListEnd

\resumeProjectHeading
    {\textbf{Youtube Recommendation Analysis} $|$ \emph{JavaScript, Puppeteer, Node.js, Torch, Transformers}}{2025}
    \resumeItemListStart
      \resumeItem{Developed a data pipeline to sample, pair, and harvest 50K YouTube recommendations using sock-puppet accounts.}
\resumeItem{Developed a git-diff-inspired text algorithm to identify matching video pairs, achieving 97\% accuracy (0.95 precision, 0.96 recall), and trained a custom BERT model to classify the political leaning of content.}
    \resumeItemListEnd
